...
def main(params):
    params['input_json'] = r'data/train_val_videodatainfo.json'
    ...
    params['input_json'] = r'data/test_videodatainfo.json'
    videos = json.load(open(params['input_json'], 'r'))['sentences']
    #video_caption = {}
    for i in videos:
        if i['video_id'] not in video_caption.keys():
...
if __name__ == "__main__":
    ...
    #                    help='msr_vtt videoinfo json')
    #parser.add_argument('--info_json', default='data/train_val_info.json',
    #                    help='info about iw2word and word2ix')
    #parser.add_argument('--caption_json', default='data/train_val_caption.json', help='caption json file')

    #parser.add_argument('--input_json', type=str, default='data/test_videodatainfo.json',
    #                    help='msr_vtt videoinfo json')
    parser.add_argument('--info_json', default='data/total_info.json',
                        help='info about iw2word and word2ix')
    parser.add_argument('--caption_json', default='data/total_caption.json', help='caption json file')
